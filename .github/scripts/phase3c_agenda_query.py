...
# Extend the permanent operational contract.
...
extra = """assert.doesNotMatch(agenda,/pacientes\\(\\*\\)/,'Agenda week query must not request every patient column');
...
console.log('Operational Data Loading contract Phase 3C: Agenda/Finance selectors are lightweight, polling sleeps when hidden, and Agenda joins only required patient fields.');
"""
