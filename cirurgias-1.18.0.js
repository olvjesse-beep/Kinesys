...
// --- CABEÇA, PESCOÇO E TRAUMA FACIAL ---
    ...
    // Catálogo ortopédico estruturado — protocolos de progressão serão associados por versão.
    "lca com menisco": { exibicao:"Reconstrução do LCA + reparo meniscal", categoria:"Joelho", regiaoAnatomica:["joelho","membro_inferior"], estruturasAfetadas:["lca","menisco_medial","menisco_lateral"], riscosClinicos:["restricao_carga","restricao_flexao"], protocoloStatus:"revisao_clinica_pendente" },
    "lca com meniscectomia": { exibicao:"Reconstrução do LCA + meniscectomia parcial", categoria:"Joelho", regiaoAnatomica:["joelho","membro_inferior"], estruturasAfetadas:["lca","menisco_medial","menisco_lateral"], riscosClinicos:["derrame","inibicao_quadriceps"], protocoloStatus:"revisao_clinica_pendente" },
    "canto posterolateral": { exibicao:"Reconstrução do canto posterolateral", categoria:"Joelho", regiaoAnatomica:["joelho","membro_inferior"], estruturasAfetadas:["ligamento_popliteofibular","canto_posterolateral"], riscosClinicos:["restricao_carga","instabilidade_rotacional"], protocoloStatus:"revisao_clinica_pendente" },
    "lcp com canto posterolateral": { exibicao:"Reconstrução do LCP + canto posterolateral", categoria:"Joelho", regiaoAnatomica:["joelho","membro_inferior"], estruturasAfetadas:["lcp","canto_posterolateral"], riscosClinicos:["restricao_carga","instabilidade_rotacional"], protocoloStatus:"revisao_clinica_pendente" },
    "reparo de raiz meniscal": { exibicao:"Reparo de raiz meniscal", categoria:"Joelho", regiaoAnatomica:["joelho","membro_inferior"], estruturasAfetadas:["raiz_meniscal"], riscosClinicos:["restricao_carga","restricao_flexao"], protocoloStatus:"revisao_clinica_pendente" },
    "reparo radial meniscal": { exibicao:"Reparo radial meniscal", categoria:"Joelho", regiaoAnatomica:["joelho","membro_inferior"], estruturasAfetadas:["menisco_medial","menisco_lateral"], riscosClinicos:["restricao_carga","restricao_flexao"], protocoloStatus:"revisao_clinica_pendente" },
    "orif bimaleolar": { exibicao:"Osteossíntese de fratura bimaleolar", categoria:"Tornozelo", regiaoAnatomica:["tornozelo","membro_inferior"], estruturasAfetadas:["maleolo_medial","maleolo_lateral"], riscosClinicos:["restricao_carga","rigidez"], protocoloStatus:"revisao_clinica_pendente" },
    "reparo do manguito rotador": { exibicao:"Reparo do manguito rotador", categoria:"Ombro", regiaoAnatomica:["ombro","membro_superior"], estruturasAfetadas:["manguito_rotador"], riscosClinicos:["restricao_elevacao","restricao_carga"], protocoloStatus:"revisao_clinica_pendente" },
    "estabilizacao bankart": { exibicao:"Reparo de Bankart / estabilização anterior", categoria:"Ombro", regiaoAnatomica:["ombro","membro_superior"], estruturasAfetadas:["labrum_anterior","capsula_articular"], riscosClinicos:["restricao_rotacao_externa","restricao_carga"], protocoloStatus:"revisao_clinica_pendente" },
    "orif olecrano": { exibicao:"Osteossíntese de fratura do olécrano", categoria:"Cotovelo", regiaoAnatomica:["cotovelo","membro_superior"], estruturasAfetadas:["olecrano","triceps"], riscosClinicos:["restricao_carga","rigidez"], protocoloStatus:"revisao_clinica_pendente" },
    "artroscopia quadril impacto": { exibicao:"Artroscopia do quadril por impacto femoroacetabular", categoria:"Quadril", regiaoAnatomica:["quadril","membro_inferior"], estruturasAfetadas:["labrum_acetabular","articulacao_coxofemoral"], riscosClinicos:["restricao_carga","restricao_flexao"], protocoloStatus:"revisao_clinica_pendente" },
    "orif radio distal": { exibicao:"Osteossíntese de fratura do rádio distal", categoria:"Punho e mão", regiaoAnatomica:["punho","membro_superior"], estruturasAfetadas:["radio_distal","articulacao_radiocarpal"], riscosClinicos:["restricao_carga","rigidez"], protocoloStatus:"revisao_clinica_pendente" },
};
