...
assert(index.includes('src/core/operational_resume_refresh-1.0.0.js?v=20260912-home-mobile-r4'),
...
assert(resume.includes("const PROFESSIONAL_HOME_ASSET_VERSION='20260912-home-mobile-r4';"),
