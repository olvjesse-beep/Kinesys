...
const casos = [
  ...
  {id:'R-O13-ac-manguito-coexistem',hma:'Tenho dor lateral ao elevar o braço e também dor bem no topo do ombro quando cruzo o braço para o lado contrário.',regioes:['ombro'],aplicar:['ombro'],inclui:{ombro:['ombro_manguito','ombro_ac']},ordem:{ombro:['ombro_manguito','ombro_ac']}},
  ...
  {id:'R-C11-cervical-e-local-coexistem',hma:'A dor vem do pescoço até a mão com formigamento, mas também tenho dor focal lateral no cotovelo que piora ao apertar a mão.',regioes:['cotovelo'],aplicar:['cotovelo'],inclui:{cotovelo:['cotovelo_cervical_neural','cotovelo_lateral']},top:{cotovelo:'cotovelo_cervical_neural'},ordem:{cotovelo:['cotovelo_cervical_neural','cotovelo_lateral']}},
  {id:'R-C12-rotulo-ombro-nao-supera-local',hma:'Tive bursite no ombro anos atrás. Agora a dor é focal do lado de fora do cotovelo e aparece ao apertar a mão e estender o punho.',regioes:['ombro','cotovelo'],aplicar:['cotovelo'],inclui:{cotovelo:['cotovelo_lateral']},naoInclui:{cotovelo:['cotovelo_ombro_referida']},top:{cotovelo:'cotovelo_lateral'}},
