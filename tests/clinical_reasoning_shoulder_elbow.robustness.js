...
const casos = [
  ...
  {id:'R-O12-ruptura-negada',hma:'Ombro dói para elevar, mas não perdi força, o braço não cai e consigo levantar sozinho.',regioes:['ombro'],aplicar:['ombro'],naoInclui:{ombro:['ombro_ruptura_manguito']}},
