...
assert.match(index,/script-1\.18\.0\.js\?v=20260910-hma-perf-r3&patient_self_service=20260910-r1[^"']*core_mod=20260911-phase4n-r1/,'Script precisa invalidar cache sem perder o contrato anterior');
