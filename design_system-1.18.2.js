...
(function(){
    ...
    function prepararHome(){
        ...
        const grid=document.createElement('div');grid.className='ks-home-stats';grid.innerHTML=`<div class="ks-home-stat-action" role="button" tabindex="0" data-ks-home-detail="atendimentos" aria-label="Abrir atendimentos das últimas 24 horas"><span>Atendimentos · últimas 24 horas</span><strong id="ks_home_agenda_count">—</strong><b class="ks-home-stat-arrow">›</b></div><div class="ks-home-stat-action" role="button" tabindex="0" data-ks-home-detail="recentes" aria-label="Abrir pacientes recentes"><span>Cadastros recentes</span><strong id="ks_home_recent_count">—</strong><b class="ks-home-stat-arrow">›</b></div>`;
