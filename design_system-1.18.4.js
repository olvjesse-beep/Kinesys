...
(function(){
    ...
    function prepararHome(){
        ...
        const grid=document.createElement('div');grid.className='ks-home-stats';grid.innerHTML=`<div class="ks-home-stat-action" role="button" tabindex="0" data-ks-home-detail="recentes" aria-label="Abrir cadastros das últimas 24 horas"><span>Cadastros · últimas 24 horas</span><strong id="ks_home_recent_count">—</strong><b class="ks-home-stat-arrow">›</b></div>`;
