...
(function iniciarModuloFinanceiro(global){
    ...
    function atualizarAcoesContextuais(){
        ...
        document.querySelectorAll('[data-fin-patient-action]').forEach(botao=>botao.hidden=!contaVisivel);
    }
    ...
    global.KineSysFinanceiro=Object.freeze({versao:VERSAO,inicializar,resumoSeguro,estornarPagamento,obterComposicaoFormasPagamento,validarComposicaoFormasPagamento,atualizarDivisaoPagamento,aposRender,buscarPacientes,abrirPaciente,fecharPaciente});
