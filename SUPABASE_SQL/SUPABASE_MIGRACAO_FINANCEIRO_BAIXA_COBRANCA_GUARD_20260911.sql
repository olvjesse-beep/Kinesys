-- KineSys — guard de consistência para baixa de cobrança individual
-- Aplicada em produção como: financeiro_baixa_cobranca_guard_20260911
...
begin
  ...
  if c.baixada_em is not null then
    return jsonb_build_object('ok',true,'repetido',true,'agendamento_id',p_agendamento_id,'baixada_em',c.baixada_em);
  end if;
