...
(function () {
  ...
  var VERSAO_MOTOR_HMA = '11.0-discriminacao-fenotipica';
  ...
  function classificarConceitoHMA(chave) {
    ...
    var comportamento = ['carga','flexao','extensao','decubitoLateral','apoioUnipodal','transferencia','elevacaoBraco','provocacaoOmbro','preensao','salto','valsalvaLombar','pioraMovimentoPescoco','provocacaoSindesmose'];
  ...
  var KINESYS_REGIOES_CONCEITOS_SCORE = {
    ...
    joelho: ['joelho','joelhoAnterior','linhaArticularJoelho','torcaoJoelho','flexaoJoelhoCarga','sinalTeatroFemoropatelar','crepitacaoJoelho','rigidezCurtaJoelho','hiperextensaoJoelho','mecanicoJoelho','bloqueioVerdadeiroJoelho','derrameJoelho','derramePrecoceJoelho','derrameTardioJoelho','instabilidadeJoelho','falseioObjetivoJoelho','ligamentoMedialJoelho','ligamentoLateralJoelho','tratoIliotibial','pataGanso','cistoPopliteo','salto','instabilidadePatelar','padraoLCA','incapacidadeExtensaoAtivaJoelho','rupturaMecanismoExtensorJoelho','bursitePrepatelar','tendaoQuadriceps'],
